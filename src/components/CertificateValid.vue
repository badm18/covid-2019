            ...
            <div class="lang-en">
              ...
              >
                ...
                <g mask="url(#mask20)">
                  ...
                  <path
                    d="M0 8.09485H36V16.207H0V8.09485Z"
                    fill="#0039A6"
                  ></path>
                  <path
            ...
            <div class="lang-ru">
              ...
              >
                ...
                <g mask="url(#mask0)">
                  ...
                  <path
                    d="M0 8.09485H37.5V16.207H0V8.09485Z"
                    fill="#0039A6"
                  ></path>
                  <circle
                    cx="11.7499"
    ...
    <div>
      <div class="status-container mt-28">
        ...
        <div class="status-container-inner">
          ...
          <h4 class="title-h4 white status-title mt-12">
            ...
            <span class="unrz">{{
              getLangText(`user.${userCk}.certificateNumber`)
            }}</span>
          </h4>
        </div>
      </div>
      ...
      <div class="person-data person-data-dates mt-12">
        <div class="mb-4 person-data-wrap align-items-center">
          ...
          <div class="small-text gray">{{ getLangText("expiredDate") }}</div>
        </div>
      </div>
      <div class="person-data person-data-attrs mt-24">
        <div class="mb-4 person-data-wrap attr-wrap">
          ...
          <div class="attrValue title-h6 bold text-center">
            {{ getLangText(`user.${userCk}.fullName`) }}
          </div>
        </div>
        <div class="mb-4 person-data-wrap attr-wrap">
          ...
          <div class="attrValue small-text gray">
            {{ getLangText(`user.${userCk}.dateOfBirth`) }}
          </div>
        </div>
        <div class="mb-4 person-data-wrap attr-wrap">
          <div class="small-text mb-4 mr-4 attr-title">
          ...
          <div class="attrValue small-text gray">
            {{ getLangText(`user.${userCk}.passport`) }}
          </div>
        </div>
      </div>
      <div class="mt-24">
...
export default {
  ...
  methods: {
    switchLang() {
      ...
      const switchLangTo = this.$vuetify.lang.current === "ru" ? "en" : "ru";

      this.$vuetify.lang.current = switchLangTo;
